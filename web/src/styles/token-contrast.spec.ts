...
const PAIRINGS: readonly {
  ...
  { foreground: 'action-primary', background: 'surface-canvas', kind: 'text' },
  { foreground: 'action-primary', background: 'surface-panel', kind: 'text' },
  { foreground: 'action-primary', background: 'surface-raised', kind: 'text' },
