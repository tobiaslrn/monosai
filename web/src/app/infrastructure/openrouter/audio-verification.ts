...
/**
 * MP3 is requested from every provider. `audio/wav` is the lossless fallback
 * when Gemini still answers with PCM. Legacy WebM support belongs to playback,
 * not this boundary for accepting newly generated clips.
 */
