...
- Anki application/bridge not running, connection timeout, permission/CORS/private-network denial, unsupported API action, malformed response, or query failure.
