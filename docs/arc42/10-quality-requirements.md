...
| Q6 | Usability, no spend | A reading opens with no translation, no grammar review, and no audio | Zero outbound requests until a control is pressed | Browser journeys with a stubbed provider that fails the test on an unexpected call |
