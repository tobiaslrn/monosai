...
| **The model catalog**        | Reads the capabilities a model declares, including the provider-reported completion maximum used by Settings; a probe then confirms compatibility. See [ADR 0040](../decisions/0040-speech-capabilities-are-declared.md) and [ADR 0076](../decisions/0076-model-reported-story-output-budgets.md) |
